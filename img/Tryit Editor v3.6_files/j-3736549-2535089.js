...
(function(){
    ...
    (function() {
    var p = "3736549", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3736549||'',
    GUID:window.ftGUID_3736549||'99999999999',
    confID:window.ftConfID_3736549||'0',
    ftReturn: window.ftReturn_3736549||'',
    keyword:window.ftKeyword_3736549||'',
    ftId:window.ftId_3736549||'',
    imp:window.ftImp3736549,
    ftImpId:window.ftImp3736549 && window.ftImp3736549.impID || '',
    campaignID:'104107',
    cID:'100887',
    pID:'3736549',
    creativeID:'2535089',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104107&sid=3155&plc=3736549&num=&adid=&advid=&adsrv=29&btreg=3736549&btadsrv=flashtalking&crt=2535089&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ["http://servedby.flashtalking.com/click/8/104107;3736549;2535089;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/creativecloud/plans.html?plan=edu&locale=en&sdid=TKZTLFVF&mv=display"],
    placementDescription:'QuantcastFY19EDURTREDUOverallUSPAWB728x90',
    width:728,
    height:90,
    ...
    divID:'ftdiv3736549',
    phID:'ftpos3736549',
    frameID:'ftframe3736549',
    expID:'ftexpframe3736549',
    altImgID:'ftalt3736549',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/104107;3736549;2535089;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/creativecloud/plans.html?plan=edu&locale=en&sdid=TKZTLFVF&mv=display',
    altImg:'http://servedby.flashtalking.com/imp/8/104107;3736549;204;gif;Quantcast;QuantcastFY19EDURTREDUOverallUSPAWB728x90/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/104107;3736549;271;pixel;Quantcast;QuantcastFY19EDURTREDUOverallUSPAWB728x90/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/373/3736549/2535089/js/j-3736549-2535089.js',
    file:'http://cdn.flashtalking.com/100887/2535089/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?135592246-3736549;2535089;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_3736549||'',
    segmentList:window.ftSegmentList_3736549||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3736549 && window.ftImp3736549.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3736549')&&/^https:/.test(document.getElementById('ftscript_m3736549').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3736549'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3736549'],
        ['ftcfid', 'ftConfID_3736549'],
        ['fttime', 'ftTimestamp_3736549'],
        ['ftsection', 'ftSection_3736549'],
        ['ftcustom', 'ftCustom_3736549'],
        ['ft_id', 'ftId_3736549'],
        ['ftimpid','ftImp3736549', 'impID']
    ]
};
...
//TA_1 min
//ftMinified
(function(b){var c=window["ftImp"+b.pID]&&window["ftImp"+b.pID].privacy;c&&"x"!==c||((new Image).src=b.replaceMacros("ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2035&ta_partner_did=[GUID]&ta_format=png",!0),"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]),window.ftD9ResponseRegister.push({getD9Id:function(){return window.ft_d9ID||""},d9Response:function(b){var a="";try{a=b.DeviceID[0]}catch(d){}"timeout"!=a&&a?this.getD9Id()||(window.ft_d9ID=a||"",this.getD9Id()&&(this.d9Response=function(){})):a="";a&&((new Image).src="ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2176&ta_partner_did="+a+"&ta_format=png")}}))}(ft3736549));
